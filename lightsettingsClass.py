...
class lightsettingsClass:
    ...
    def lightprofiles(self):
        ...
        if previous_key_val:
            ...
            self.w.check_Right_Enable.setChecked(int(lines[int(profile.previous_key)+2][70]))
            self.w.check_Top_RGB.setChecked(int(lines[int(profile.previous_key)+2][72]))
            self.w.check_Left_RGB.setChecked(int(lines[int(profile.previous_key)+2][74]))
            self.w.check_Right_RGB.setChecked(int(lines[int(profile.previous_key)+2][76]))
            self.w.check_Top_White.setChecked(int(lines[int(profile.previous_key)+2][78]))
